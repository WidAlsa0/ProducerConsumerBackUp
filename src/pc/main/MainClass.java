...
//		c.addMouseListener(null);
	...
	public static void animateArrayUseInteractive() {
		...
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "cook", AttributeNames.TOOLBAR_METHOD, true);
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "cook", AttributeNames.LABEL, "Cook");
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "eat", AttributeNames.TOOLBAR_METHOD, true);
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "eat", AttributeNames.LABEL, "Eat");
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "serveDish", AttributeNames.TOOLBAR_METHOD, true);
		ObjectEditor.setMethodAttribute(AProducerConsumerScene.class, "serveDish", AttributeNames.LABEL, "Serve Dish");
		...
		editor.getDrawComponent().setBackground(Color.GRAY);
